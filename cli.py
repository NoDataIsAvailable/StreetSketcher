...
@click.option('--country','-c',default=None, help='Limit search to country')
...
def generate(name, postal_code,country, output_path, resolution):
    if not name and not postal_code:
        raise ValueError("no name or postal-code was given")
    
    generate_img(name,postal_code, output_path ,resolution,country)
